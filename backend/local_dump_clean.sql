...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017  /*!50003 TRIGGER `trg_after_payment_insert` AFTER INSERT ON `payments` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017  /*!50003 TRIGGER `trg_after_payment_update` AFTER UPDATE ON `payments` FOR EACH ROW BEGIN
