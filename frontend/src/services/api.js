const API_BASE_URL = import.meta.env.VITE_API_BASE_URL || import.meta.env.VITE_API_URL || 'https://visioncoderslifestyleproductsbackend-production.up.railway.app/api';
